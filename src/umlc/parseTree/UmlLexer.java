...
public class UmlLexer extends antlr.CharScanner implements UmlParserTokenTypes, TokenStream
 {
public UmlLexer(InputStream in) {
	this(new ByteBuffer(in));
}
public UmlLexer(Reader in) {
	this(new CharBuffer(in));
}
public UmlLexer(InputBuffer ib) {
	this(new LexerSharedInputState(ib));
}
public UmlLexer(LexerSharedInputState state) {
	super(state);
	caseSensitiveLiterals = true;
	setCaseSensitive(true);
	literals = new Hashtable();
	literals.put(new ANTLRHashString("string", this), new Integer(38));
	...
	literals.put(new ANTLRHashString("float", this), new Integer(35));
	literals.put(new ANTLRHashString("part", this), new Integer(26));
	literals.put(new ANTLRHashString("char", this), new Integer(33));
	literals.put(new ANTLRHashString("double", this), new Integer(37));
	literals.put(new ANTLRHashString("extends", this), new Integer(14));
	literals.put(new ANTLRHashString("byte", this), new Integer(32));
	literals.put(new ANTLRHashString("void", this), new Integer(30));
	literals.put(new ANTLRHashString("whole", this), new Integer(25));
	literals.put(new ANTLRHashString("association", this), new Integer(19));
	literals.put(new ANTLRHashString("decimal", this), new Integer(39));
	literals.put(new ANTLRHashString("long", this), new Integer(36));
...
tryAgain:
	...
	public final void mPROTECTED(boolean _createToken) throws RecognitionException, CharStreamException, TokenStreamException {
		int _ttype; Token _token=null; int _begin=text.length();
		_ttype = PROTECTED;
		int _saveIndex;
	...
	public final void mINFINITY(boolean _createToken) throws RecognitionException, CharStreamException, TokenStreamException {
		int _ttype; Token _token=null; int _begin=text.length();
		_ttype = INFINITY;
		int _saveIndex;
	...
	public final void mLSQR(boolean _createToken) throws RecognitionException, CharStreamException, TokenStreamException {
		int _ttype; Token _token=null; int _begin=text.length();
		_ttype = LSQR;
		int _saveIndex;
	...
	public final void mRSQR(boolean _createToken) throws RecognitionException, CharStreamException, TokenStreamException {
		int _ttype; Token _token=null; int _begin=text.length();
		_ttype = RSQR;
		int _saveIndex;
	...
	public final void mLANGBRACE(boolean _createToken) throws RecognitionException, CharStreamException, TokenStreamException {
		int _ttype; Token _token=null; int _begin=text.length();
		_ttype = LANGBRACE;
		int _saveIndex;
	...
	public final void mRANGBRACE(boolean _createToken) throws RecognitionException, CharStreamException, TokenStreamException {
		int _ttype; Token _token=null; int _begin=text.length();
		_ttype = RANGBRACE;
		int _saveIndex;
