// $ANTLR 2.7.5 (20050128): "annotations.g" -> "AnnotationsLexer.java"$
...
public class AnnotationsLexer extends antlr.CharScanner implements AnnotationParserTokenTypes, TokenStream
 {
public AnnotationsLexer(InputStream in) {
	this(new ByteBuffer(in));
}
public AnnotationsLexer(Reader in) {
	this(new CharBuffer(in));
}
public AnnotationsLexer(InputBuffer ib) {
	this(new LexerSharedInputState(ib));
}
public AnnotationsLexer(LexerSharedInputState state) {
	super(state);
...
tryAgain:
	...
	public final void mEscapeSequence(boolean _createToken) throws RecognitionException, CharStreamException, TokenStreamException {
		int _ttype; Token _token=null; int _begin=text.length();
