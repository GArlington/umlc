...
public class BentStyle extends SerializableEnumeration
{
   ...
   */
   ...
   public String stringValue() {
       if (this == STRAIGHT) return "Straight";
       if (this == HV) return "HV";
       if (this == VH) return "VH";
       if (this == HVH) return "HVH";
       if (this == VHV) return "VHV";
       return "HVH";
   }
   
   public static BentStyle fromString(String s) {
       if ("Straight".equals(s)) return STRAIGHT;
       if ("HV".equals(s)) return HV;
       if ("VH".equals(s)) return VH;
       if ("HVH".equals(s)) return HVH;
       if ("VHV".equals(s)) return VHV;
       return HVH;
   }
