...
import com.horstmann.violet.ClassEditor;
...
public class GraphPanel extends JPanel
{
   ...
   public void editSelected()
   {
      ...
      // bad form using instanceof...should use interface!
      if (edited instanceof JMatterClassNode) {
          JMatterClassNode node = (JMatterClassNode) edited;
          
          if (generator == null) System.out.println("gp gen is null");
          ClassEditor editor = new ClassEditor(generator, node, this);
          ...
          JOptionPane.showMessageDialog(EditorFrame.getMainFrame(), sheet, 
                ResourceBundle.getBundle("com.horstmann.violet.framework.EditorStrings").getString("dialog.properties"),            
                JOptionPane.QUESTION_MESSAGE);          
      }
      

//      JDialog d = new JDialog(EditorFrame.getMainFrame(), ResourceBundle.getBundle("com.horstmann.violet.framework.EditorStrings").getString("dialog.properties"), false);
//      d.setResizable(true);
//      Dimension pref  = new Dimension();//(sheet.getPreferredSize().getWidth() + 30, sheet.getPreferredSize().getHeight() + 30);
//      pref.setSize(sheet.getPreferredSize().getWidth() + 30, sheet.getPreferredSize().getHeight() + 30);
//      d.setPreferredSize(pref );
//      d.getContentPane().add(sheet);
//      d.setSize(sheet.getPreferredSize());
//      d.setVisible(true);
//      setModified(true);
   }
